...
import com.example.restaurantsearcher.databinding.FragmentInputKeyWordBinding
import com.example.restaurantsearcher.ui.adapter.RangeListAdapter
import com.example.restaurantsearcher.ui.viewmodel.InputKeyWordViewModel
...
class InputKeyWordFragment : Fragment() {
    ...
    private fun navigateToSearchLocationFragment(range: Int) {
        val action =
            InputKeyWordFragmentDirections.actionInputKeyWordFragmentToSearchFragment(
                inputText,
                range
            )
