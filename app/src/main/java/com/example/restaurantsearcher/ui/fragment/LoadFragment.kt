...
import com.example.restaurantsearcher.databinding.FragmentLoadBinding
import com.example.restaurantsearcher.ui.viewmodel.LoadViewModel
import com.google.android.material.dialog.MaterialAlertDialogBuilder

//パーミッションの確認画面と位置情報の取得画面
class LoadFragment : Fragment() {
    private val viewModel: LoadViewModel by viewModels()
    private var _binding: FragmentLoadBinding? = null
    private val binding get() = _binding!!
    private val args: LoadFragmentArgs by navArgs()
    ...
    private fun navigateToResultListFragment(searchTerms: SearchTerms) {
        val action = LoadFragmentDirections.actionLoadFragmentToResultFragment(searchTerms)
