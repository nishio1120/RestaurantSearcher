...
import com.example.restaurantsearcher.ui.viewmodel.SearchViewModel
...
class SearchFragment : Fragment() {
    ...
    private fun navigateToResultListFragment(searchTerms: SearchTerms) {
        val action = SearchFragmentDirections.actionSearchFragmentToResultFragment(searchTerms)
